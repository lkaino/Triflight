...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    DEF_TIM(TIM3,  CH1,  PA6,  TIM_USE_MOTOR | TIM_USE_SERVO, 1 ),  // PWM5 [TIM3_CH1 (D1_CH6)] [TIM16_CH1  (D1_CH3 / D1_CH6)]
    DEF_TIM(TIM3,  CH2,  PA7,  TIM_USE_MOTOR | TIM_USE_SERVO, 1 ),  // PWM6
    DEF_TIM(TIM3,  CH3,  PB0,  TIM_USE_MOTOR | TIM_USE_SERVO, 1 ),  // PWM7
    DEF_TIM(TIM3,  CH4,  PB1,  TIM_USE_MOTOR | TIM_USE_SERVO, 1 ),  // PWM8
#endif
