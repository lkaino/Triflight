...
#if defined(OMNIBUSF4SD)
    DEF_TIM(TIM5,  CH2, PA1,  TIM_USE_MOTOR | TIM_USE_SERVO,               TIMER_OUTPUT_STANDARD, 0), // S5_OUT
...
#endif
    DEF_TIM(TIM1,  CH1, PA8,  TIM_USE_MOTOR | TIM_USE_SERVO,               TIMER_OUTPUT_STANDARD, 0), // S6_OUT
