...
#ifndef LUXV2_RACE
    DEF_TIM(TIM2,  CH1, PA0,  TIM_USE_MOTOR | TIM_USE_SERVO, 1), // PWM6 - PA0
    DEF_TIM(TIM2,  CH2, PA1,  TIM_USE_MOTOR | TIM_USE_SERVO, 1), // PWM7 - PA1
    DEF_TIM(TIM2,  CH3, PA2,  TIM_USE_MOTOR | TIM_USE_SERVO, 1), // PWM8 - PA2
    DEF_TIM(TIM2,  CH4, PA3,  TIM_USE_MOTOR | TIM_USE_SERVO, 1), // PWM9 - PA3
