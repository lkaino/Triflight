...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    DEF_TIM(TIM15, CH2, PA3,  TIM_USE_MOTOR | TIM_USE_SERVO, 1 ), // PWM7  - PA3  - *TIM15_CH2, TIM2_CH4
    DEF_TIM(TIM1,  CH1, PA8,  TIM_USE_MOTOR | TIM_USE_SERVO, 1 ), // PWM8  - PA8  - *TIM1_CH1, TIM4_ETR
