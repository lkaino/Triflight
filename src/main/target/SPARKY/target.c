...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    DEF_TIM(TIM15, CH2, PB15, TIM_USE_MOTOR | TIM_USE_SERVO,               1), // PWM1  - PB15 - TIM1_CH3N, TIM15_CH1N, *TIM15_CH2
    DEF_TIM(TIM15, CH1, PB14, TIM_USE_MOTOR | TIM_USE_SERVO,               1), // PWM2  - PB14 - TIM1_CH2N, *TIM15_CH1
    DEF_TIM(TIM1,  CH1, PA8,  TIM_USE_MOTOR,               1), // PWM3  - PA8  - *TIM1_CH1, TIM4_ETR
    ...
    DEF_TIM(TIM17, CH1, PA7,  TIM_USE_PWM,                 1), // PWM8  - PA7  - !TIM3_CH2, *TIM17_CH1, TIM1_CH1N, TIM8_CH1
