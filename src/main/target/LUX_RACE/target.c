...
#ifndef LUXV2_RACE
    { TIM2,  IO_TAG(PA0),  TIM_Channel_1, TIM_USE_MOTOR | TIM_USE_SERVO, 1, GPIO_AF_1, NULL, 0 }, // PWM6 - PA0
    { TIM2,  IO_TAG(PA1),  TIM_Channel_2, TIM_USE_MOTOR | TIM_USE_SERVO, 1, GPIO_AF_1, NULL, 0 }, // PWM7 - PA1
    { TIM2,  IO_TAG(PA2),  TIM_Channel_3, TIM_USE_MOTOR | TIM_USE_SERVO, 1, GPIO_AF_1, NULL, 0 }, // PWM8 - PA2
    { TIM2,  IO_TAG(PA3),  TIM_Channel_4, TIM_USE_MOTOR | TIM_USE_SERVO, 1, GPIO_AF_1, NULL, 0 }, // PWM9 - PA3
